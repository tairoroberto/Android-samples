...
import br.com.trmasolucoes.tcmaterialdesign.adapters.TabsAdapter;
import br.com.trmasolucoes.tcmaterialdesign.domain.Car;
import br.com.trmasolucoes.tcmaterialdesign.domain.Person;
import br.com.trmasolucoes.tcmaterialdesign.extras.SlidingTabLayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (getIntent() != null && getIntent().getStringExtra(CarWidgetProvider.FILTER_CAR_ITEM) != null) {
            ...
            /** Seta a intent para null, para evitar recarregar indesejadamente*/
            setIntent(null);
